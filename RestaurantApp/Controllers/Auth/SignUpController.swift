...
class SignUpController: UIViewController, UITextFieldDelegate {
    ...
    private func setupButtons() {
        let attribute5 = NSMutableAttributedString(string: "Already a user? ", attributes: [NSAttributedString.Key.font : UIFont.systemFont(ofSize: 15), NSAttributedString.Key.foregroundColor : Restaurant.shared.textColor])
        attribute5.append(NSAttributedString(string: "Sign In", attributes: [NSAttributedString.Key.foregroundColor : Restaurant.shared.themeColor, NSAttributedString.Key.font : UIFont.boldSystemFont(ofSize: 15)]))
